    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                createCS355Frame(controller, view, controller, controller);
            }
        });
    }
...
//                if(scrollbarToChange == jScrollBar1) {
//                    controller.vScrollbarChanged(number);
//                } else if(scrollbarToChange == jScrollBar2) {
//                    controller.hScrollbarChanged(number);
//                }
                break;
            default:
